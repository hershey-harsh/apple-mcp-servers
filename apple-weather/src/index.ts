...
const noaaService = new NOAAService({
  userAgent: `apple-weather-mcp/${SERVER_VERSION} (https://github.com/hershey-harsh/apple-mcp-servers)`
});
...
async function main() {
  ...
  try {
    ...
    logger.info('Version check', {
      ...
      repository: 'https://github.com/hershey-harsh/apple-mcp-servers'
    });
  } catch (error) {
